            ...
            >
              ...
              >
                <div className="flex flex-col gap-1">
                  ...
                  {(item.is_project === true || item.is_project === 1) && (
                    <div>
                      <span className="inline-flex items-center rounded-md border border-violet-200 bg-violet-50 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wide text-violet-700">
                        Project
                      </span>
                    </div>
                  )}
              ...
              {showPriceIntelligence && (
                <>
                  ...
                  <td className="border border-slate-200 px-3 py-4">
                    <PriceVarianceCell intelligence={item.price_intelligence} />
                  </td>
