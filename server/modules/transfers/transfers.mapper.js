...
export function mapTransfer(row) {
  return {
    ...
    from_catalog_item_id: row.from_catalog_item_id,
    to_catalog_item_id: row.to_catalog_item_id,
    ...
    from_unit_price: toNumber(row.from_unit_price),
    to_unit_price: toNumber(row.to_unit_price),
    from_base_quantity: toNumber(row.from_base_quantity),
    to_base_quantity: toNumber(row.to_base_quantity),
    from_remaining_before_transfer: toNumber(row.from_remaining_before_transfer),
    from_remaining_after_transfer: toNumber(row.from_remaining_after_transfer),
    to_remaining_before_transfer: toNumber(row.to_remaining_before_transfer),
    to_remaining_after_transfer: toNumber(row.to_remaining_after_transfer),
...
export function mapTransferSubItem(row) {
  return {
    ...
    generic_item_name: row.generic_item_name || row.catalog_item_name,
    name: row.name,
    model_name: row.model_name || row.sub_item_name,
    sub_item_name: row.sub_item_name,
    expense_type: row.expense_type,
    quantity: toNumber(row.quantity),
    unit_price: toNumber(row.unit_price),
    approved_transfer_in_quantity: toNumber(row.approved_transfer_in_quantity),
    approved_transfer_out_quantity: toNumber(row.approved_transfer_out_quantity),
    pending_transfer_out_quantity: toNumber(row.pending_transfer_out_quantity),
    approved_po_linked_quantity: toNumber(row.approved_po_linked_quantity),
    pending_po_linked_quantity: toNumber(row.pending_po_linked_quantity),
