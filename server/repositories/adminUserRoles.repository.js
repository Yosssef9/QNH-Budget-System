...
export async function getUserRolesRepo() {
...
export async function findDuplicateUserRole({ user_id, department_id, role_id }) {
  const pool = await poolPromise;
...
export async function createUserRoleRepo(payload) {
  const pool = await poolPromise;
...
export async function updateUserRoleRepo(id, payload) {
  const pool = await poolPromise;
...
export async function updateUserRoleStatusRepo(id, isActive) {
  const pool = await poolPromise;
